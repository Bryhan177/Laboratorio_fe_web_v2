...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, OverlayModule, AvatarModule, OverlayBadgeModule, MenuModule, ButtonModule, DialogModule, InputTextModule, PasswordModule, FormsModule, DropdownModule, InputNumberModule],
