...
export class ThemeLanguageControlsComponent {
    ...
    get languageButtonClass(): string {
        switch (this.variant) {
            ...
            case 'floating':
                return 'inline-flex h-11 items-center gap-2 rounded-full border border-surface-200 bg-white px-3 text-surface-700 shadow-sm transition-all hover:bg-surface-100 dark:border-surface-700 dark:bg-surface-900 dark:text-surface-100 dark:hover:bg-surface-800';
            default:
                return 'relative inline-flex h-11 items-center gap-2 rounded-full border border-[#28A0AE]/25 bg-[#28A0AE] px-3 text-white transition-all duration-200 hover:bg-[#28A0AE] hover:text-white dark:border-[#FFDCC2]/30 dark:bg-[#FFDCC2]/10 dark:text-[#FFDCC2] dark:hover:bg-[#FF7F02] dark:hover:text-white dark:hover:border-[#FF7F02]';
        }
    }
    ...
    get themeButtonClass(): string {
        switch (this.variant) {
            ...
            default:
                return 'relative inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#28A0AE]/25 bg-[#28A0AE] text-white transition-all duration-200 hover:bg-[#28A0AE] hover:text-white dark:border-[#FFDCC2]/30 dark:bg-[#FFDCC2]/10 dark:text-[#FFDCC2] dark:hover:bg-[#FF7F02] dark:hover:text-white dark:hover:border-[#FF7F02]';
        }
    }
